...
<%--Nav Bar--%>
        ...
        <br />
                <%--Pagina--%>
        <h2>Registra nuevo Caso Positivo de Alumno</h2>
        ...
        <br />
        <asp:Button class="btn btn-primary" ID="Button_agregar_Positivo_Alumno" runat="server" Text="Button" OnClick="Button_agregar_Positivo_Alumno_Click"/>
         <br />
