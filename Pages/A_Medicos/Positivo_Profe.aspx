<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Positivo_Profe.aspx.cs" Inherits="Seguimineto_COVID.Pages.A_Medicos.Positivo_Profe" %>
            ...
            <div class="container-fluid col-xl-8 col-md-12">
                <div class="card">
                    <div class="card-body centerContent">
                        <h5 class="card-title">Registra nuevo Caso Positivo de Profesor</h5>
                        ...
                        <br />
                        <br />
                        <asp:Button class="btn btn-dark" ID="Button_agregar_Positivo_Profesor" runat="server" Text="Button" OnClick="Button_agregar_Positivo_Profesor_Click" />
                        <br />
