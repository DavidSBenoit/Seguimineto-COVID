...
<body>
    <form id="form1" runat="server">
        ...
        <br />
        <%--Pagina--%>
        <h2>Registra nuevo Caso Positivo de Profesor</h2>
        ...
        <br />
        <asp:Button class="btn btn-primary" ID="Button_agregar_Positivo_Profesor" runat="server" Text="Button" OnClick="Button_agregar_Positivo_Profesor_Click" />
        <br />
