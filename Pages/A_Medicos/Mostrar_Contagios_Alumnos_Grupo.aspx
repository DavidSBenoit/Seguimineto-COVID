<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Mostrar_Contagios_Alumnos_Grupo.aspx.cs" Inherits="Seguimineto_COVID.Pages.A_Medicos.Mostrar_Contagios_Alumnos_Grupo" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Contagios Alumnos por Grupo</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="col-md-12">
            ...
            <asp:DropDownList ID="DropDownList_grupo" runat="server" AutoPostBack="true" OnSelectedIndexChanged="DropDownList_grupo_SelectedIndexChanged"></asp:DropDownList>
