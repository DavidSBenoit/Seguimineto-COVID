...
<body>
    <form id="form1" runat="server">
        ...
        <br />
        <asp:Button class="btn btn-primary" ID="Button_Editar_Medico" runat="server" Text="Editar" OnClick="Button_Editar_Medico_Click"/>
         <br />
        <asp:Button class="btn btn-primary" ID="Button_Eliminar_Medico" runat="server" Text="Eliminar" OnClick="Button_Eliminar_Medico_Click"/>
        <br />
