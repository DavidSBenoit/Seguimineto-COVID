<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Mostrar_Contagios_Profe.aspx.cs" Inherits="Seguimineto_COVID.Pages.A_Escolares.Mostrar_Contagios_Profe" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Contagios Profesores</title>
            ...
            <div class="container-fluid col-xl-8 col-md-12">
                <div class="card">
                    <div class="card-body centerContent">
                        <h5 class="card-title">Mostrar Profesores Contagiados</h5>
