<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Mostrar_Profesores.aspx.cs" Inherits="Seguimineto_COVID.Pages.Mostrar_Profesores" %>
            ...
            <div class="container-fluid col-xl-8 col-md-12">
                <div class="card">
                    <div class="card-body centerContent">
                        <h5 class="card-title">Área de Alumnos</h5>
                        <a href="/Pages/A_Profesores/Agregar_Profesor.aspx" class="btn btn-dark" tabindex="-1" role="button">Agregar Alumno</a>
                        <a href="/Pages/A_Profesores/Ediat_Profesores.aspx" class="btn btn-dark" tabindex="-1" role="button">Editar Alumno</a>
                        <br />
                        <br />
