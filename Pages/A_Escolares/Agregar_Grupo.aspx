<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Agregar_Grupo.aspx.cs" Inherits="Seguimineto_COVID.Pages.A_Escolares.Agregar_Grupo" %>
            ...
            <div class="container-fluid col-xl-8 col-md-12">
                <div class="card">
                    <div class="card-body centerContent">
                        <h5 class="card-title">Agregar Grupo</h5>
                        <p>Ingresa los Datos</p>

                <p>Grado</p>
                <asp:TextBox ID="TextBox_grado" runat="server"></asp:TextBox>
                <br />

                <p>Letra</p>
                <asp:TextBox ID="TextBox_letra" runat="server"></asp:TextBox>
                <br />
                        <br />
                <asp:Button ID="Button_agregar_grupo" class="btn btn-dark" runat="server" Text="Agregar" OnClick="Button_agregar_grupo_Click"/>
                <br />
