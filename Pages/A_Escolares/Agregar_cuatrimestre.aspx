<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Agregar_cuatrimestre.aspx.cs" Inherits="Seguimineto_COVID.Pages.A_Escolares.Agregar_cuatrimestre" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            <div class="col-md-12">
                ...
                <p>Fin</p>
                <asp:Calendar ID="Calendar_fin" runat="server"></asp:Calendar>
                <br />

                <asp:Button ID="Button_agregar_cuatrimestre" runat="server" Text="Button" OnClick="Button_agregar_cuatrimestre_Click"/>
                <br />
