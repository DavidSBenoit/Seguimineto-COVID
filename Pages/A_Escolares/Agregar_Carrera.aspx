<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Agregar_Carrera.aspx.cs" Inherits="Seguimineto_COVID.Pages.A_Escolares.Agregar_Carrera" %>
...
<%--nav bar--%>
        ...
        <%--pagina--%>
            ...
            <div class="container-fluid col-xl-8 col-md-12">
                ...
                <asp:TextBox ID="TextBox_nombrecarrera" runat="server"></asp:TextBox>
                <br />
                        <br />
                <asp:Button ID="Button_agregar_carrera" class="btn btn-dark" runat="server" Text="Agregar" OnClick="Button_agregar_carrera_Click" />
                <br />
