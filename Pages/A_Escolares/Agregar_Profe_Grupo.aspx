<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Agregar_Profe_Grupo.aspx.cs" Inherits="Seguimineto_COVID.Pages.A_Escolares.Agregar_Profe_Grupo" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Agregar Profe Grupo</title>
            ...
            <div class="container-fluid col-xl-8 col-md-12">
                <div class="card">
                    <div class="card-body centerContent">
                        <h5 class="card-title">Agregar Profesor Grupo</h5>
                        <p>Ingresa los Datos</p>

                <p>Selecciona Profesor</p>
                <asp:DropDownList ID="DropDownList_Profe" runat="server"></asp:DropDownList>
                <br />
                ...
                <br />
                        <br />
                <asp:Button ID="Button_agregar_GrupoCuatri" runat="server" class="btn btn-dark" Text="Agregar" OnClick="Button_agregar_GrupoCuatri_Click"/>
                <br />
