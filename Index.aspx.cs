...
namespace Seguimineto_COVID
{
    public partial class Index : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            List<AlumnoGrupo> ListaAlumnoGrupo = Interfaz.ListaAlumnoGrupo(ref mensaje, ref mensajeC);
            List<Carrera> ListaCarrera = Interfaz.ListaCarrera(ref mensaje, ref mensajeC);
            List<Cuatrimestre> ListaCuatrimestre = Interfaz.ListaCuatrimestre(ref mensaje, ref mensajeC);
            List<EstadoCivil> ListaEstadoCivil = Interfaz.ListaEstadoCivil(ref mensaje, ref mensajeC);
            List<Grupo> ListaGrupo = Interfaz.ListaGrupo(ref mensaje, ref mensajeC);
            List<GrupoCuatrimestre> ListaGrupoCuatrimestre = Interfaz.ListaGrupoCuatrimestre(ref mensaje, ref mensajeC);
            List<Incapacidades> ListaIncapacidades = Interfaz.ListaIncapacidades(ref mensaje, ref mensajeC);
            List<Medico> ListaMedico = Interfaz.ListaMedico(ref mensaje, ref mensajeC);
            List<PositivoAlumno> ListaPositivoAlimno = Interfaz.ListaPositivoAlumno(ref mensaje, ref mensajeC);
            List<PositivoProfe> ListaPositivoProfe = Interfaz.ListaPositivoProfe(ref mensaje, ref mensajeC);
            List<ProfeGrupo> ListaProfeGrupo = Interfaz.ListaProfeGrupo(ref mensaje, ref mensajeC);
            List<Profesor> ListaProfesor = Interfaz.ListaProfesor(ref mensaje, ref mensajeC);
            List<ProgramaEducativo> ListaProgramaEducativo = Interfaz.ListaProgramaEducativo(ref mensaje, ref mensajeC);
